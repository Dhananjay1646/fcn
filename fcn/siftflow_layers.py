...
class SIFTFlowSegDataLayer(caffe.Layer):
    ...
    def load_label(self, idx, label_type=None):
        ...
        if label_type == 'semantic':
            #label = Image.open('{}/SemanticLabels/spatial_envelope_256x256_static_8outdoorcategories/{}.png'.format(self.siftflow_dir, idx))['S']
            label = scipy.io.loadmat('{}/SemanticLabels/spatial_envelope_256x256_static_8outdoorcategories/{}.mat'.format(self.siftflow_dir, idx))['S'] #mat->png
